...
//Start of printing
startCalcAmp = period1*20.0*Q1;
startprintF = period1*20.0*Q1 + NN*period1;
...
for (z_base_counter = (z_base_max); z_base_counter > -160.0; z_base_counter = z_base_counter - 5.0)
{
